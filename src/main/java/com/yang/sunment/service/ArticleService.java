...
public interface ArticleService {
     ...
     * @return 该页所有文章
     */
    JSONArray findAllArticles(String rows, String pageNo,String articleAbstract);
     ...
     * @return 文章名
     */
    Map<String, String> findArticleTitle(long articleId, String originalAuthor);
     ...
     * @return
     */
    JSONObject getArticle(long articleId, String originalAuthor, String username);
     ...
     * @return 目前点赞数
     */
    int updateLike(long articleId, String originalAuthor);
     ...
     * @return 该分类下文章的数目
     */
    int countArticleCategory(String category);
     ...
     * @return 该归档日期下文章的数目
     */
    int countArticleArchive(String archive);
     ...
     * @return 该页所有文章
     */
    JSONArray myArticle(String rows, String pageNo,String author);
}
