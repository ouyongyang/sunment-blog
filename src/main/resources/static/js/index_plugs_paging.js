...
(function($, window, document, undefined) {
	...
	function Paging(element, options) {
		...
		this.options = {
			...
			total:options.total,
            flag:options.flag,
            articleAbstract:options.articleAbstract,
	...
	Paging.prototype = {
		...
		creatHtml: function() {
            ...
            var articleAbstract = me.options.articleAbstract;
		...
		bindEvent: function() {
			...
			me.element.on('click', 'a', function() {
				...
				if(me.options.callback) {
					me.options.callback(me.options.pageNum,me.options.articleAbstract);
				}
			});
		}
	};
	//通过jQuery对象初始化分页对象
	$.fn.indexpaging = function(options) {
