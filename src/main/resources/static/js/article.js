...
function putInArticle(data) {
    $('.oyy-article-top').html('');
    $('.oyy-article-footer').html('');
    var articleTop = $('<article-top><div class="article-title">' +
        ...
        '<i class="am-icon-calendar"><a class="articleCategoryColor" href="/jump/archives?archive=' + data.publishDate + '"> ' + data.publishDate + '</a></i>' +
        '</div>' +
        ...
        '<i class="am-icon-folder"> <a class="articleCategoryColor" href="/jump/categories?category=' + data.articleCategories + '">' + data.articleCategories + '</a></i>' +
        '</div>' +
        '</div></article-top><div class="article-i-say">' +
        '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- 三盟</span>' +
        '</div>');
    $('.oyy-article-top').append(articleTop);
    ...
    var articleFooter = $('<div class="end-logo">' +
        ...
        '</span>' +
        '</div>');
    $('.oyy-article-footer').append(articleFooter);
    var tags = $('<div class="tags"></div>');
    for(var i=0;i<data.articleTags.length;i++){
        var tag = $('<i class="am-icon-tag"></i><a class="articleTagColor" href="/jump/tags?tag=' + data.articleTags[i] + '"> ' + data.articleTags[i] + '</a>');
        tags.append(tag);
    }
    ...
    $('.other').append($('<div class="social-share" data-initialized="true" data-url="http://localhost:8080/jump/findArticle?articleId=' + data.articleId + '&originalAuthor='+ data.originalAuthor + '"  data-title="' + data.articleTitle + '">' +
